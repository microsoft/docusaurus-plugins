...
Running your tool on all snippets on every build of the documentation might slow your build to a grind
so it's important to setup caching in GitHub Actions.
