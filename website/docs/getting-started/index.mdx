...
Install typescript and typing files to support TypeScript in Docusaurus.

```bash
yarn add --dev typescript @docusaurus/module-type-aliases @tsconfig/docusaurus
```

and add a TypeScript configuration file improve the experience in VS Code.

```json file="website/tsconfig.json"
{
