...
Aside from the console output, additional files can also be injected in the page. In the example below, `msagl`
renders a graph in SVG which gets inserted in the page.
